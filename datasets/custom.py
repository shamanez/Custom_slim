...
"""
This doesn't have to do anything with the functionality of the script.for
It's better if you could update this dict appropriately
"""
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
    ...
    """
    You might have to change the image/format default value
    """
    keys_to_features = {
